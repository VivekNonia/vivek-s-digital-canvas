  ...
  return (
    <section id="skills" className="section-container relative overflow-hidden" ref={ref}>
      ...
      <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto">
        {/* Development Skills */}
        <div className={`glass-card p-10 hover:border-primary/40 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1 glow-effect scroll-reveal ${isVisible ? 'revealed delay-200' : ''}`}>
          <div className="flex items-center gap-4 mb-10">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 flex items-center justify-center border border-primary/10">
            ...
            {devSkills.map((skill) => (
              <div key={skill.name} className="group">
                ...
                <div className="w-full h-2 bg-secondary rounded-full overflow-hidden border border-border/50">
                  <div
                    className="h-full bg-gradient-to-r from-primary to-primary/60 rounded-full transition-all duration-500 group-hover:shadow-lg group-hover:shadow-primary/50"
        ...
        {/* Design Skills */}
        <div className={`glass-card p-10 hover:border-primary/40 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1 glow-effect scroll-reveal ${isVisible ? 'revealed delay-400' : ''}`}>
          <div className="flex items-center gap-4 mb-10">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500/20 to-pink-500/20 flex items-center justify-center border border-primary/10">
